...
export const actions = addPrefix(ACTION_PREFIX, {
  ...
  SET_STATE: "SET_STATE", // deprecated
  GET_STATE: "GET_STATE", // deprecated
  UPDATE_STATE: "UPDATE_STATE", // deprecated
  ...
  SEND_PLUGIN_EVENT: "SEND_PLUGIN_EVENT",
  SET_STORAGE_STATE: "SET_STORAGE_STATE"
});
