...
export enum SCOPE_CHANGE_EVENTS {
  ...
  NAVIGATION_HISTORY_NAVIGATION_BUTTON_CLICKED = "NAVIGATION/HISTORY_NAVIGATION_BUTTON_CLICKED",
  NAVIGATION_ENVIRONMENT_MENU_ITEM_SELECTED = "NAVIGATION/ENVIRONMENT_MENU_ITEM_SELECTED",
  ...
  RECENT_ACTIVITY_ENVIRONMENT_TAB_SELECTED = "RECENT_ACTIVITY/ENVIRONMENT_TAB_SELECTED",
  RECENT_ACTIVITY_SPAN_LINK_CLICKED = "RECENT_ACTIVITY_SPAN_LINK_CLICKED",
  IDE_ISSUE_CODE_LENS_CLICKED = "IDE/ISSUE_CODE_LENS_CLICKED",
  IDE_RUNTIME_DATA_CODE_LENS_CLICKED = "IDE/RUNTIME_DATA_CODE_LENS_CLICKED",
  IDE_NOTIFICATION_LINK_CLICKED = "IDE/NOTIFICATION_LINK_CLICKED"
  // TODO: Add events triggered by actions in the plugin (code lens, native notifications, etc.)
}
