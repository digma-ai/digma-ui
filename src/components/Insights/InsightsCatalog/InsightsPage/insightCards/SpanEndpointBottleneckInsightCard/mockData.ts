    ...
    slowEndpoints: [
      ...
      },
      {
        endpointInfo: {
          ...
          serviceName: "Sample.MoneyTransfer.API",
          codeObjectId:
            "Sample.MoneyTransfer.API.Controllers.SampleInsightsController$_$Lock(Double) 1",
          spanCodeObjectId:
            "span:OpenTelemetry.Instrumentation.AspNetCore$_$HTTP GET SampleInsights/lock/{milisec} 1",
          spanName: "HTTP GET SampleInsights/lock/{milisec}"
        },
        traceId: "traceId",
        probabilityOfBeingBottleneck: 0.36877828054298645,
