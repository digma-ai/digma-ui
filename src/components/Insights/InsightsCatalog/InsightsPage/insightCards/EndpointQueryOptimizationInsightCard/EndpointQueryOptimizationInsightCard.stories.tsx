...
import { EndpointQueryOptimizationInsightCard } from ".";
import { mockedEndpointQueryOptimizationInsight } from "./mockData";

// More on how to set up stories at: https://storybook.js.org/docs/react/writing-stories/introduction
const meta: Meta<typeof EndpointQueryOptimizationInsightCard> = {
  title:
    "Insights/InsightsCatalog/InsightsPage/insightCards/EndpointQueryOptimizationInsightCard",
  component: EndpointQueryOptimizationInsightCard,
  parameters: {
