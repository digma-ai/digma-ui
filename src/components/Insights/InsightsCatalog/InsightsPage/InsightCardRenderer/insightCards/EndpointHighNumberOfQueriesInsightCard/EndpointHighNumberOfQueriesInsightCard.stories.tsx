...
const meta: Meta<typeof EndpointHighNumberOfQueriesInsightCard> = {
  title:
    "Insights/InsightsCatalog/InsightsPage/InsightCardRenderer/insightCards/HighNumberOfQueriesInsightCard",
...
type Story = StoryObj<typeof EndpointHighNumberOfQueriesInsightCard>;
