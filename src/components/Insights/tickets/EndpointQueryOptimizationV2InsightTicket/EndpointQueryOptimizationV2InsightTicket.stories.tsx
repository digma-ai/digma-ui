...
import { mockedEndpointQueryOptimizationV2Insight } from "../../common/insights/EndpointQueryOptimizationV2Insight/mockData";

// More on how to set up stories at: https://storybook.js.org/docs/react/writing-stories/introduction
const meta: Meta<typeof EndpointQueryOptimizationV2InsightTicket> = {
  title: "Insights/tickets/EndpointQueryOptimizationV2InsightTicket",
