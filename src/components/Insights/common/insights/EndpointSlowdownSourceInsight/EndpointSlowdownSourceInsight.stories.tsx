...
import { EndpointSlowdownSourceInsight } from ".";
import { InsightCategory, InsightScope, InsightType } from "../../../types";

// More on how to set up stories at: https://storybook.js.org/docs/react/writing-stories/introduction
const meta: Meta<typeof EndpointSlowdownSourceInsight> = {
  title: "Insights/common/insights/EndpointSlowdownSourceInsight",
  component: EndpointSlowdownSourceInsight,
  parameters: {
