...
export const mockedAgentEvents: IncidentAgentEvent[] = [
  ...
  },
  {
    ...
    section: {
      ...
      summary: "Investigated traces for performance issues",
      status: "completed"
    },
    events: [
      {
      ...
      },
      {
        id: "2-3",
        type: "token",
        message: "Found potential issues in the following areas:",
        agent_name: "agent"
      }
    ]
  },
  ...
  },
  {
    ...
    section: {
      ...
      summary: "Investigated codebase for potential issues",
      status: "active"
    }
  }
];
